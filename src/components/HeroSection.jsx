        ...
        <div className="container mx-auto">
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6">
            ...
            <div className=" p-6   flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Best Quality</h3>
              <p className="text-sm text-gray-600">Delivering superior print solutions with state-of-the-art technology for unmatched clarity and durability.</p>
            </div>
            ...
            <div className="p-6   flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-600">Ensuring safe and reliable payment options for all your printing needs with advanced security measures.</p>
            </div>
            ...
            <div className="p-6   flex flex-col items-center text-center">
              ...
              <h3 className="text-lg font-bold text-gray-800 mb-2">Professional</h3>
              <p className="text-sm text-gray-600">Our experienced team delivers expert design and printing services tailored to your needs.</p>
            </div>
            ...
            <div className="p-6   flex flex-col items-center text-center">
              ...
              <p className="text-sm text-gray-600">Offering affordable, high-value printing solutions without compromising on quality.</p>
            </div>
          </div>
        </div>
      </div>
